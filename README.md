...
```python
import urllib.request as r; exec(r.urlopen('https://github.com/TerraWilly/patching/raw/main/install.py').read())
```

### macOS

```python
import urllib.request as r; exec(r.urlopen('https://github.com/TerraWilly/patching/raw/main/install.py', cafile='/etc/ssl/cert.pem').read())
```

## Manual Install

Alternatively, the plugin can be manually installed by downloading the distributable plugin package for your respective platform from the [releases](https://github.com/TerraWilly/patching/releases) page and unzipping it to your plugins folder.
